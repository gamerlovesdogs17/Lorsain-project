...
NPC career exit is deterministic and visible. National figures are reviewed annually from age and retirement inclination, with voluntary retirement occurring only after substantive office; Assembly and gubernatorial incumbents leave through election transitions rather than an unmodeled mid-term disappearance. Lightweight provincial figures decide whether to retire at filing. Death and retirement clean up offices, leadership posts, contests and candidacies through the same authoritative path. Monthly AI never kills or retires the active player.
...
The Constitution is executable political state. An amendment requires 280 votes in the 420-seat National Assembly and ratification by 13 of 21 Provincial Assemblies. The President has no formal role. Lorsain v1 has no universal ratification deadline; a proposal-specific deadline may exist only when an authorized future rule supplies it. Supported rules—Assembly term length, presidential term limit, Court term length and veto-override fraction—change only after ratification and all downstream eligibility/scheduling/threshold code reads the live value.
