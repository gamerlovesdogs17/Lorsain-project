...
Do not mark the public site validated merely because the workflow exists. Confirm the latest Actions deployment and exercise New Game, End Turn, save/reload, maps, and an election from the public address.
