...
- Add deterministic NPC retirement/death and filing-stage provincial retirement so the starting cohort does not remain active for fifty years; reuse office/leadership/candidacy cleanup and never decide the player's exit.
...
- Make constitutional procedure executable: 280 Assembly votes, 13 of 21 Provincial Assembly ratifications, no presidential role, no invented universal deadline, and supported constitutional rules stored in runtime state.
