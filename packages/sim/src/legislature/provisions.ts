...
export const LEGISLATIVE_PROVISIONS: readonly LegislativeProvisionDefinition[] = [
  ...
  variableProvision(
    ...
    "Federal adequacy rules govern transfers to designated partner jurisdictions",
    [
      option(
        "contractual_self_regulation",
        "Contractual self-regulation",
        "Allows firms to self-certify cross-border transfers under model contracts without a public registry.",
        "Cross-Border Data Contracts Bill",
        {
          direction: -0.75,
          magnitude: 0.62,
          fiscalImpact: -0.04,
          affectedGroups: ["Individuals", "Technology firms", "Provinces"],
          dimensionEffects: { social: -0.45, authority: -0.35, globalism: 0.4 },
          controlHint: "binary",
        },
      ),
      option(
        "provincial_opt_out",
        "Provincial opt-out transfers",
        "Sets a federal baseline but lets provinces authorize stricter or looser transfer rules locally.",
        "Provincial Data Transfer Bill",
        {
          direction: -0.2,
          magnitude: 0.42,
          fiscalImpact: 0.02,
          affectedGroups: ["Provinces", "Technology firms", "Individuals"],
          dimensionEffects: { authority: -0.25, nationalism: 0.2 },
          controlHint: "categorical",
        },
      ),
      option(
        "founding_federal_adequacy",
        "Federal adequacy rules govern transfers to designated partner jurisdictions",
        "Retains federal adequacy designations and standard transfer safeguards.",
        "Cross-Border Data Code",
        {
          direction: 0,
          magnitude: 0.12,
          fiscalImpact: 0,
      ...
      option(
        ...
        "Consent and portability mandate",
        "Requires explicit consent, exportable copies, and a public registry of transfer categories.",
        "Digital Consent and Portability Bill",
        {
          direction: 0.65,
          magnitude: 0.58,
          fiscalImpact: 0.07,
          affectedGroups: ["Individuals", "Courts", "Technology firms"],
          dimensionEffects: { social: 0.55, authority: 0.2 },
          controlHint: "binary",
        },
      ),
    ],
  ...
  variableProvision(
    "PROV_TEMP_WORKER",
    "ISS_IMMIGRATION",
    "Temporary foreign worker admissions",
    "Employer-sponsored temporary permits with sector caps and renewal limits",
    [
      option(
        "open_sectoral_permits",
        "Open sectoral permits",
        "Removes annual caps for designated shortage sectors while keeping employer sponsorship.",
        "Sectoral Temporary Worker Bill",
        {
          direction: 0.75,
          magnitude: 0.68,
          fiscalImpact: 0.05,
          affectedGroups: groupsForIssue("ISS_IMMIGRATION"),
          dimensionEffects: { globalism: 0.55, economic: -0.15 },
          controlHint: "categorical",
        },
      ),
      option(
        "annual_cap_enforcement",
        "Annual cap enforcement",
        "Lowers annual permit caps and ties renewals to labor-market tests.",
        "Temporary Worker Cap Bill",
        {
          direction: -0.55,
          magnitude: 0.55,
          fiscalImpact: -0.03,
      ...
      option(
        "founding_sponsored_temp",
        "Employer-sponsored temporary permits with sector caps and renewal limits",
        "Retains employer sponsorship, sector caps, and limited renewals.",
      ...
      option(
        "pathway_after_four_years",
        "Permanent pathway after four years",
        "Creates a permanent residency track for temporary workers after four years in shortage sectors.",
        "Temporary-to-Permanent Pathway Bill",
        {
          direction: 0.45,
          magnitude: 0.52,
          fiscalImpact: 0.08,
  ...
  variableProvision(
    ...
    "ISS_TRADE",
    "Consumer credit and lending rules",
    "National interest caps and disclosure standards apply to retail lenders",
    [
      option(
        "market_disclosure_only",
        "Market disclosure only",
        "Repeals interest caps and relies on disclosure and competition enforcement.",
        "Consumer Lending Deregulation Bill",
        {
          direction: -0.8,
          magnitude: 0.7,
          fiscalImpact: -0.05,
          affectedGroups: ["Households", "Retail banks", "Consumer advocates"],
          dimensionEffects: { economic: -0.5, authority: -0.4 },
          controlHint: "binary",
        },
      ),
      option(
        "founding_interest_caps",
        "National interest caps and disclosure standards apply to retail lenders",
        "Retains interest caps, fee disclosure, and ombudsman access.",
      ...
      option(
        "public_lender_competition",
        "Public lender competition",
        "Creates a postal banking lender competing on basic credit and deposit products.",
        "Public Retail Banking Bill",
        {
          direction: 0.55,
          magnitude: 0.58,
          fiscalImpact: 0.18,
          affectedGroups: ["Households", "Retail banks", "Postal operator"],
          dimensionEffects: { economic: 0.45, authority: 0.35 },
          controlHint: "categorical",
        },
      ),
      option(
        "predatory_lending_ban",
        "Predatory lending ban",
        "Bans short-term rollover products and sets a strict all-in cost ceiling.",
        "Predatory Lending Prohibition Bill",
        {
          direction: 0.85,
          magnitude: 0.65,
          fiscalImpact: 0.04,
          affectedGroups: ["Households", "Retail banks", "Consumer advocates"],
          dimensionEffects: { social: 0.4, economic: 0.25 },
          controlHint: "threshold",
        },
      ),
    ],
  ...
  variableProvision(
    ...
    "Departments may deploy cameras where locally funded",
    [
      option(
        "voluntary_department",
        "Voluntary department deployment",
        "Prohibits mandates and limits federal funding to voluntary pilot programs.",
        "Optional Body Camera Bill",
        {
          direction: -0.6,
          magnitude: 0.5,
          fiscalImpact: -0.03,
      ...
      option(
        "incentive_grants",
        "Incentive grants",
        "Offers conditional grants for departments adopting retention and access rules.",
        "Body Camera Incentive Bill",
        {
          direction: 0.15,
          magnitude: 0.4,
          fiscalImpact: 0.06,
      ...
      option(
        "founding_local_funding",
        "Departments may deploy cameras where locally funded",
        "Retains optional local deployment without a national mandate.",
        "Body Camera Guidance Code",
        {
          direction: 0,
          magnitude: 0.08,
          fiscalImpact: 0,
      ...
      option(
        "mandatory_recording",
        "Mandatory recording",
        "Requires body-worn cameras on uniformed patrol with public access rules for serious incidents.",
        "Mandatory Body Camera Bill",
        {
          direction: 0.75,
          magnitude: 0.62,
          fiscalImpact: 0.11,
          affectedGroups: groupsForIssue("ISS_POLICING"),
          dimensionEffects: { social: 0.35, authority: 0.25 },
          controlHint: "binary",
        },
      ),
    ],
  ...
  variableProvision(
    "PROV_GAS_BRIDGE",
    "ISS_CLIMATE",
    "Natural gas bridge policy",
    "Existing gas plants may operate through published retirement schedules",
    [
      option(
        "extend_gas_assets",
        "Extend gas assets",
        "Delays published retirement dates and allows new peaking gas where grid reliability is certified.",
        "Gas Reliability Extension Bill",
        {
          direction: -0.85,
          magnitude: 0.72,
          fiscalImpact: -0.04,
          affectedGroups: groupsForIssue("ISS_CLIMATE"),
          dimensionEffects: { green: -0.65, economic: -0.2 },
          controlHint: "duration",
        },
      ),
      option(
        "founding_retirement_schedule",
        "Existing gas plants may operate through published retirement schedules",
        "Retains published retirement schedules for existing gas capacity.",
        "Gas Transition Code",
        {
          direction: 0,
          magnitude: 0.1,
      ...
      option(
        "hydrogen_incentive",
        "Hydrogen retrofit incentive",
        "Funds hydrogen-ready retrofits but prohibits new fossil peaking after 2032.",
        "Hydrogen Transition Incentive Bill",
        {
          direction: 0.35,
          magnitude: 0.5,
          fiscalImpact: 0.14,
          affectedGroups: groupsForIssue("ISS_CLIMATE"),
          dimensionEffects: { green: 0.45, economic: 0.15 },
          controlHint: "categorical",
        },
      ),
      option(
        "mandate_phaseout",
        "Mandated gas phase-out",
        "Prohibits new gas connections and requires closure of plants by fixed statutory dates.",
        "Fossil Phase-Out Mandate Bill",
        {
          direction: 0.9,
          magnitude: 0.75,
          fiscalImpact: 0.09,
          affectedGroups: groupsForIssue("ISS_CLIMATE"),
          dimensionEffects: { green: 0.75, economic: 0.35, authority: 0.3 },
          controlHint: "binary",
        },
      ),
    ],
  ...
  variableProvision(
    ...
    "High-impact automated decisions require documented human review",
    [
      option(
        "voluntary_industry_codes",
        "Voluntary industry codes",
        "Relies on industry codes without a public registry of high-impact systems.",
        "Algorithm Self-Regulation Bill",
        {
          direction: -0.7,
          magnitude: 0.6,
          fiscalImpact: -0.03,
          affectedGroups: ["Executive", "Technology firms", "Individuals"],
          dimensionEffects: { authority: -0.45, social: -0.35 },
          controlHint: "binary",
        },
      ),
      option(
        "provincial_sandbox",
        "Provincial regulatory sandboxes",
        "Allows provinces to run supervised sandboxes with lighter federal audit duties.",
        "Provincial AI Sandbox Bill",
        {
          direction: -0.15,
          magnitude: 0.42,
          fiscalImpact: 0.02,
          affectedGroups: ["Provinces", "Technology firms", "Executive"],
          dimensionEffects: { authority: -0.2, nationalism: 0.15 },
          controlHint: "categorical",
        },
      ),
      option(
        "founding_human_review",
        "High-impact automated decisions require documented human review",
        "Retains human review duties for high-impact automated decisions.",
        "Automated Decision Code",
        {
          direction: 0,
          magnitude: 0.1,
          fiscalImpact: 0,
          founding: true,
          affectedGroups: ["Executive", "Public", "Courts"],
        },
      ),
      option(
        "national_audit_registry",
        "National audit registry",
        "Creates a mandatory registry, independent audits, and suspension power for high-risk systems.",
        "Algorithm Accountability Bill",
        {
          direction: 0.7,
          magnitude: 0.65,
          fiscalImpact: 0.1,
          affectedGroups: ["Executive", "Technology firms", "Courts"],
          dimensionEffects: { authority: 0.55, social: 0.35 },
          controlHint: "binary",
        },
      ),
    ],
  ...
  variableProvision(
    ...
    "ISS_OWNERSHIP",
    "Retail deposit insurance coverage",
    "Deposits are insured up to a published statutory cap per account",
    [
      option(
        "low_cap_private",
        "Low cap private backstop",
        "Lowers the insured cap and shifts residual risk to uninsured depositors.",
        "Deposit Insurance Reduction Bill",
        {
          direction: -0.65,
          magnitude: 0.58,
          fiscalImpact: -0.06,
          affectedGroups: ["Depositors", "Retail banks", "Taxpayers"],
          dimensionEffects: { economic: -0.45, authority: -0.3 },
      ...
      option(
        "founding_statutory_cap",
        "Deposits are insured up to a published statutory cap per account",
        "Retains the published per-account statutory cap.",
      ...
      option(
        "universal_high_cap",
        "Universal high cap",
        "Raises coverage to a high universal cap funded by risk-weighted bank premiums.",
        "Expanded Deposit Insurance Bill",
        {
          direction: 0.45,
          magnitude: 0.52,
          fiscalImpact: 0.05,
      ...
      option(
        "mutualized_public_fund",
        "Mutualized public fund",
        "Creates a mutualized public insurance fund with co-insurance for large balances.",
        "Mutual Deposit Insurance Bill",
        {
          direction: 0.75,
          magnitude: 0.62,
          fiscalImpact: 0.12,
          affectedGroups: ["Depositors", "Retail banks", "Public operator"],
          dimensionEffects: { economic: 0.4, authority: 0.45 },
          controlHint: "categorical",
        },
      ),
    ],
  ...
  variableProvision(
    ...
    "Provinces receive optional federal grants for community liaison programs",
    [
      option(
        "unfunded_mandate",
        "Unfunded standards mandate",
        "Sets national community policing standards without dedicated funding.",
        "Community Policing Standards Bill",
        {
          direction: 0.25,
          magnitude: 0.45,
          fiscalImpact: 0,
          affectedGroups: ["Provinces", "Police", "Communities"],
          dimensionEffects: { authority: 0.3, nationalism: -0.2 },
          controlHint: "binary",
        },
      ),
      option(
        "founding_optional_grants",
        "Provinces receive optional federal grants for community liaison programs",
        "Retains optional federal grants for community liaison programs.",
        "Community Policing Grants Code",
        {
          direction: 0,
          magnitude: 0.08,
          fiscalImpact: 0,
      ...
      option(
        "permanent_universal_grants",
        "Permanent universal grants",
        "Funds community liaison teams in every province through a permanent envelope.",
        "Universal Community Policing Bill",
        {
          direction: 0.55,
          magnitude: 0.55,
          fiscalImpact: 0.13,
          affectedGroups: groupsForIssue("ISS_POLICING"),
          dimensionEffects: { social: 0.35, economic: 0.2 },
          controlHint: "categorical",
        },
      ),
      option(
        "local_only",
        "Local-only programs",
        "Ends federal grants and leaves community programs entirely to municipalities.",
        "Local Policing Programs Bill",
        {
          direction: -0.55,
          magnitude: 0.5,
          fiscalImpact: -0.04,
          affectedGroups: ["Municipalities", "Police", "Communities"],
          dimensionEffects: { authority: -0.35, nationalism: 0.25 },
          controlHint: "binary",
        },
      ),
    ],
