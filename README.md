# Lorsain Political Simulator — Phase 8 Courts + Constitutional System (COMPLETE)
...
- Save schema version: **8** (independent of contentVersion and npm package versions; v1→v2→v3→v4→v5→v6→v7→v8 migrate)
